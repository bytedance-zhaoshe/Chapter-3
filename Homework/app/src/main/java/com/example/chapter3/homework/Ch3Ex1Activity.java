    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loopCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    animationView.setProgress(curProgress);
                    ...
                    curProgress = animationView.getProgress();
                    seekBar.setProgress((int) (curProgress * 100));
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                curProgress = (float) progress / (float) seekBar.getMax();
                animationView.setProgress(curProgress);
            }
